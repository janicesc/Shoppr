          ...
          <div className="relative w-full max-w-[420px]">
            ...
            <form onSubmit={handleSubmit} className="relative flex w-full flex-col sm:flex-row">
              ...
              <button
                ...
                className="px-6 sm:px-8 py-3.5 sm:py-4 bg-foreground text-cream border border-foreground font-bold uppercase tracking-wide text-sm hover:bg-pink hover:text-cream active:bg-teal active:text-cream focus-visible:bg-pink focus-visible:text-cream focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-foreground/30 disabled:opacity-70 disabled:cursor-not-allowed transition-colors whitespace-nowrap rounded-b-[10px] sm:rounded-b-none sm:rounded-r-[10px]"
              >
